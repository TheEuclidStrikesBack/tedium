...
theorem between_if : ∀ (a b c : Point),
  between a b c → |(a─b)| + |(b─c)| = |(a─c)| := by sorry
...
theorem equal_circles : ∀ (a b c : Point) (α β : Circle),
  (a.isCentre α) ∧ (a.isCentre β) ∧ (b.onCircle α) ∧ (c.onCircle β) ∧ |(a─b)| = |(a─c)| → α = β := by sorry
...
theorem point_on_circle_if : ∀ (a b c : Point) (α : Circle),
  (a.isCentre α) ∧ (b.onCircle α) ∧ |(a─c)| = |(a─b)| → c.onCircle α := by sorry
...
theorem point_on_circle_onlyif : ∀ (a b c : Point) (α : Circle),
  (a.isCentre α) ∧ (b.onCircle α) ∧ (c.onCircle α) → |(a─c)| = |(a─b)| := by sorry

--
-- 4.
-- If a is the centre of α and b is on α, and ac < ab if and only if c is in α.
--
@[aesop unsafe [forward, apply]]
...
theorem point_in_circle_if : ∀ (a b c : Point) (α : Circle),
  (a.isCentre α) ∧ (b.onCircle α) ∧ (a─c) < (a─b) → c.insideCircle α := by sorry
...
theorem point_in_circle_onlyif : ∀ (a b c : Point) (α : Circle),
  (a.isCentre α) ∧ (b.onCircle α) ∧ (c.insideCircle α) → (a─c) < (a─b) := by sorry
...
theorem sum_angles_onlyif : ∀ (a b c d : Point) (L M : Line),
(a.onLine L) ∧ (a.onLine M) ∧ (b.onLine L) ∧ (c.onLine M) ∧ (a ≠ b) ∧ (a ≠ c) ∧
¬(d.onLine L) ∧ ¬(d.onLine M) ∧ (L ≠ M) ∧ (b.sameSide d M) ∧ (c.sameSide d L) →
(∠ b:a:c) = (∠ b:a:d) + (∠ d:a:c) := by sorry
...
-/
@[aesop unsafe [apply,forward]]
theorem flat_angle_if : ∀ (a b c : Point),
  a ≠ b ∧ b ≠ c ∧ ∠ a:b:c = ∟ + ∟ → between a b c := by sorry
...
-/
@[aesop unsafe [apply,forward]]
theorem flat_angle_onlyif : ∀ (a b c : Point),
  between a b c → ∠ a:b:c = ∟ + ∟ := by sorry
...
--
-- Kaiyu: Jeremy's paper has a typo here? It says "a and d are on the same side of N"
...
theorem lines_intersect : ∀ (a b c d : Point) (L M N : Line),
  (a.onLine L) ∧ (b.onLine L) ∧ (b.onLine M) ∧ (c.onLine M) ∧ (c.onLine N) ∧ (d.onLine N) ∧
  (b ≠ c) ∧ (a.sameSide d M) ∧ (∠ a:b:c) + (∠ b:c:d) < ∟ + ∟ →
  ∃ e : Point, (e.onLine L) ∧ (e.onLine N) ∧ (e.sameSide a M) := by sorry
...
theorem degenerated_area_if : ∀ (a b c : Point) (L : Line),
...
theorem degenerated_area_onlyif : ∀ (a b c : Point) (L : Line),
  distinctPointsOnLine a b L ∧ (c.onLine L) →
  (Triangle.area △ a:b:c) = 0 := by sorry
...
theorem sum_areas_if : ∀ (a b c d : Point) (L : Line),
  (a.onLine L) ∧ (b.onLine L) ∧ (c.onLine L) ∧ (a ≠ b) ∧ (a ≠ c) ∧ (b ≠ c) ∧ ¬(d.onLine L) ∧ (between a c b) →
  (Triangle.area △ a:c:d + Triangle.area △ d:c:b = Triangle.area △ a:d:b) := by sorry
