...
import SystemE.Tactics.Translation.Solver
...
-/
def EuclidFinish : TacticM Unit := do
  ...
  if ¬unsolved.isEmpty then
    traceUnsolvedToWidget unsolved

syntax "euclid_finish" : tactic

elab "euclid_finish" : tactic => withMainContext EuclidFinish
...
set_option systemE.solverTime 180
